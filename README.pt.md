...
- **Tolitech.Infrastructure.Persistence.ConstraintValidator**: Núcleo agnóstico e interface para validadores.
- **Tolitech.Infrastructure.Persistence.ConstraintValidator.PostgreSql**: Validador específico para PostgreSQL.
- **Tolitech.Infrastructure.Persistence.ConstraintValidator.SqlServer**: Validador específico para SQL Server.
...
> **Tolitech.Infrastructure.Persistence.ConstraintValidator** simplifica o tratamento de exceções de restrição, tornando seu código mais limpo, seguro e preparado para múltiplos bancos de dados.
